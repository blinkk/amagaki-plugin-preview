...
export function parseHostname(hostname: string): ParseHostnameResult {
  ...
  app.all('/*', async (req: express.Request, res: express.Response) => {
    ...
    try {
      if (true) {
        ...
        cloudRunClient._options.rootUrl =
        ...
        // No revision matches. Use the master|main site as the base branch, but
        // download content using the newly-created workspace.
        if (!revisionRoute) {
